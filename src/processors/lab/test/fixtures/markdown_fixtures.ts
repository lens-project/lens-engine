 ...
 */
export const SIMPLE_MARKDOWN_PROCESSED = "Simple Article This is a simple test article with minimal content. It has just two paragraphs for basic testing.";

/**
 * Expected processing results for the markdown with front matter
 */
export const MARKDOWN_WITH_FRONTMATTER_PROCESSED = "Document with Front Matter This document has YAML front matter that should be removed during processing. Section This is a section of the document with more content.";
 ...
 */
export const SIMPLE_MARKDOWN_SUMMARY = "This is a simple test article with minimal content. It contains two paragraphs for basic testing purposes.";

/**
 * Mock summary for the markdown with front matter
 */
export const MARKDOWN_WITH_FRONTMATTER_SUMMARY = "This document demonstrates the use of YAML front matter in markdown files. The front matter contains metadata like title, author, date, and tags. The main content discusses how front matter should be removed during processing and includes a section with additional content.";

/**
 * Mock summary for the complex markdown
 */
export const COMPLEX_MARKDOWN_SUMMARY = `The document titled "Complex Markdown Document" demonstrates various markdown formatting features.
 ...
 */
export const SPECIAL_CHARS_MARKDOWN_SUMMARY = "This document demonstrates the use of special characters in markdown content. It shows how characters like angle brackets, ampersands, quotes, apostrophes, backslashes, backticks, and various markdown syntax symbols can be included in markdown documents.";
