...
function getDayOfWeekMultiplier(
  dayOfWeek: RankingContext["dayOfWeek"],
  article: ArticleInput,
): number {
  ...
  switch (dayOfWeek) {
    ...
    case "Monday":
      ...
      if (isProfessionalDevelopmentContent(categories, title, summary)) {
        return 1.2;
      }
...
function getDayOfWeekAdjustment(
  dayOfWeek: RankingContext["dayOfWeek"],
  article: ArticleInput,
): number {
  const categories = article.categories || [];
...
function isEntertainmentContent(
  categories: string[],
  title: string,
  summary: string,
): boolean {
...
function isPersonalDevelopmentContent(
  categories: string[],
  title: string,
  summary: string,
): boolean {
  const personalDevKeywords = [
    "personal",
    "development",
    "self-help",
    "productivity",
...
function isIndustryNewsContent(
  categories: string[],
  title: string,
  summary: string,
): boolean {
...
function isProfessionalDevelopmentContent(
  categories: string[],
  title: string,
  summary: string,
): boolean {
...
function isHeavyTechnicalContent(
  categories: string[],
  title: string,
  summary: string,
): boolean {
...
function isLightReadingContent(
  categories: string[],
  title: string,
  summary: string,
): boolean {
...
function isInterestingFactsContent(
  categories: string[],
  title: string,
  summary: string,
): boolean {
