...
export const mockArticles: ArticleInput[] = [
  {
    ...
    summary:
      "TypeScript has evolved significantly over the years, and with it, the patterns and practices that define robust enterprise applications. This comprehensive guide explores advanced TypeScript patterns including conditional types, mapped types, and template literal types that can dramatically improve code maintainability and type safety in large-scale applications.",
  ...
  {
    title:
      "10 Shocking Celebrity Secrets That Will Change Everything You Thought You Knew",
    summary:
      "You won't believe what happened when we discovered these amazing celebrity secrets that doctors don't want you to know! From shocking diet tricks to unbelievable beauty hacks, these revelations will absolutely transform your perspective on fame and fortune.",
  ...
  },
  {
    ...
    summary:
      "Quantum computing represents a fundamental shift in how we process information, offering unprecedented computational power for specific types of problems. This guide breaks down the complex concepts of quantum mechanics, qubits, and quantum algorithms into accessible explanations, exploring both current limitations and future possibilities.",
  ...
  },
  {
    ...
    summary:
      "After testing dozens of productivity methods and tools over six months, we've identified the strategies that consistently deliver results. From time-blocking techniques to digital minimalism approaches, these evidence-based methods can help you reclaim hours of productive time each week.",
  ...
  },
  {
    ...
    summary:
      "Hilarious cats doing silly things for 10 straight minutes! Watch as these furry comedians slip, slide, and surprise their way into your heart. Perfect for when you need a quick laugh break or want to share some joy with friends and family.",
  ...
  {
    title:
      "Breakthrough in Deep Learning: MIT Researchers Achieve 99% Accuracy",
    summary:
  ...
  },
  {
    ...
    summary:
      "Simple and delicious meals that busy families can prepare in 30 minutes or less. These recipes focus on fresh ingredients, minimal prep time, and maximum flavor. Perfect for weekend meal planning when you want something special but don't have hours to spend in the kitchen.",
  ...
  {
    title:
      "Investing Basics for Beginners: Your Complete Guide to Building Wealth",
    summary:
      "Learn the fundamentals of smart investing with this comprehensive beginner's guide. From understanding risk tolerance to diversification strategies, this article covers essential concepts that can help you build long-term wealth through disciplined investment practices.",
  ...
  {
    title:
      "Latest Drama in Silicon Valley: Tech CEO Feuds and Corporate Gossip",
    summary:
      "Latest drama in Silicon Valley as tech executives engage in public disputes over market strategies and company valuations. Inside sources reveal behind-the-scenes tensions and power struggles that are reshaping the technology industry landscape.",
...
export function getContextByMood(
  mood: RankingContext["userMood"],
): RankingContext | undefined {
  return mockContexts.find((context) => context.userMood === mood);
}

export function getContextsByDay(
  day: RankingContext["dayOfWeek"],
): RankingContext[] {
