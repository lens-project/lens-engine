...
export const testArticles: ArticleInput[] = [
  ...
  },
  {
    ...
    summary:
      "Major technology stocks experienced significant gains following the Federal Reserve's latest interest rate decision. Analysts discuss the implications for tech companies and growth prospects in the current economic environment.",
  ...
  },
  {
    ...
    summary:
      "After testing dozens of productivity methods, we've identified the strategies that consistently deliver results. From time-blocking to digital minimalism, these evidence-based approaches can help reclaim hours of productive time each week.",
...
export const invalidContext: Partial<RankingContext> = {
  dayOfWeek: "InvalidDay" as RankingContext["dayOfWeek"],
  timeOfDay: "morning",
};
